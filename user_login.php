...
<head>
    ...
    <title>Login Admin | UTS Sandy Irawan</title>
...
<body>
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                ...
                <p>Silahkan login untuk mengakses dokumen.</p>
            ...
            <div class="text-center login-footer">
                <p class="">Copyright © <?php echo date('Y') ?>. By Sandy (WC3parser)</p>
            </div>
        </div>   
    </div>
	...
	<body class="hold-transition login-page" style="background:url(gambar/depan/bg1.jpg)
